    ...
    <div class="col-start-2 col-span-6">
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <div class="flex flex-row justify-between items-center p-4 bg-white dark:bg-gray-800">
                <div>
                    <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Kinderen</h2>
                    <p class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">
                        Hier vind je alle Kinderen. Voeg toe, bewerk of verwijder.
                    </p>
                </div>
                <input type="text" wire:model.live="search" placeholder="Zoek kind..."
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3 cursor-pointer" wire:click="sortBy('studiekeuze_id')">
                        Studierichting
                        @if($sortField === 'studiekeuze_id')
                            <svg class="inline w-4 h-4 ml-1 {{ $sortDirection === 'asc' ? 'transform rotate-180' : '' }}" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M5.293 9.707a1 1 0 001.414 0L10 6.414l3.293 3.293a1 1 0 001.414-1.414l-4-4a1 1 0 00-1.414 0l-4 4a1 1 0 000 1.414z" clip-rule="evenodd"></path>
                            </svg>
                        @endif
                ...
                @empty
                    <tr class="bg-white border-b w-full dark:bg-gray-800 dark:border-gray-700">
                        <th scope="row" class="px-6 py-4 font-medium w-full text-gray-900 whitespace-nowrap dark:text-white">
