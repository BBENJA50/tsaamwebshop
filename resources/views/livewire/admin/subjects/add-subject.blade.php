            ...
            <div class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                <div class="flex flex-row">
                    ...
                    <div
                        ...
                        <a href="{{ route('subjects') }}" wire:navigate type="button"
                ...
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow sm:px-8 sm:py-6 sm:w-full ">
                    <form method="POST" wire:submit.prevent="saveSubject" class="max-w-xl mx-auto">
                        @csrf
                        <div class="relative z-0 w-full mb-3 group">
{{--                            make the input focussed when loading this page--}}
