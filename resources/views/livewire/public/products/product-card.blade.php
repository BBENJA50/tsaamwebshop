<div class="p-3 flex h-full justify-between flex-col">
    <div
        ...
        <a href="#">
            <img class="rounded-t-lg h-48" @if( $product->image) src="{{$product->image}}"
                 @else src="{{ asset('build/assets/images/products/'. mt_rand(0,9) . '.jpg') }}" @endif alt=""/>
        </a>
        <div class="p-3 pt-1 h-full flex flex-col justify-between">
            ...
            <a href="#"
               class="flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-tsaam-500 rounded-lg hover:bg-tsaam-600 focus:ring-4 focus:outline-none focus:ring-tsaam-300 dark:bg-tsaam-600 dark:hover:bg-tsaam-700 dark:focus:ring-tsaam-800">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 fill-white" viewBox="0 0 576 512">
