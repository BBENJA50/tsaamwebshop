        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg ">
            <div class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow sm:px-8 sm:py-6 sm:w-full ">
                    <form method="POST" wire:submit.prevent="update" class="max-w mx-auto">
                        @csrf
                        <div class="grid md:grid-cols-2 md:gap-6">
                            <div>
                                ...
                                <div class="relative z-0 w-full mb-3 group">
                                    ...
                                    <textarea wire:model="description" value=" {{ $description }}" id="description"
                                              rows="4"
                                ...
                                <div class="grid md:grid-cols-2 md:gap-6">
                                    ...
                                    <div class="relative z-0 w-full mb-3 group">
                                        ...
                                        <select wire:model="category_id" id="categories"
                                            ...
                                            <option value="Selecteer een categorie" selected disabled>Selecteer een
                                                categorie.
                                            </option>
