                ...
                <div class="flex flex-row">
                    <div
                        ...
                        <p class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">
                            Hier vind je alle vakken. Voeg toe, bewerk of verwijder.
                        </p>
                    </div>
                    <div
                        ...
                        <a href="{{ route('addsubject') }}" wire:navigate type="button"
                ...
                @forelse( $subjects as $subject )
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4 text-right flex justify-end">
                            <a  href="#" wire:click="delete({{ $subject->id }})" wire:confirm="Ben je zeker dat je {{ $subject->name }} wilt verwijderen?"
