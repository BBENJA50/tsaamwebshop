                                    ...
                                    <table class="table-auto w-full">
                                        ...
                                        @foreach($cart as $item)
                                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                                ...
                                                <td class="py-3 px-6 text-left w-1/6">€{{ number_format($item['price'], 2) }}</td>
                                                <td class="py-3 px-6 text-left w-1/6">€{{ number_format($item['price'] * $item['quantity'], 2) }}</td>
                                                <td class="py-3 px-6 text-left w-1/6">
                                                    <button wire:click="removeProductFromCart({{ $item['id'] }})">Verwijder</button>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
