<div id="exampleWrapper" class="overflow-hidden grid grid-cols-8 gap-4 pt-2 pb-2">
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg ">
            <div class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow sm:px-8 sm:py-6 sm:w-full ">
                    <form method="POST" wire:submit.prevent="update" class="max-w-xl mx-auto">
                        ...
                        <div class="grid md:grid-cols-2 md:gap-6">
                            <div class="relative z-0 w-full mb-3 group">
                                ...
                                <input wire:model="first_name" value=" {{ $child->first_name }}" type="text"
                                       id="first_name"
                            ...
                            <div class="relative z-0 w-full mb-3 group">
                                ...
                                <input wire:model="last_name" value=" {{ $child->last_name }}" type="text"
                                       id="last_name"
                                       class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                @error( 'last_name')
                                <div class="text-red-500">{{ $message }}</div>
                        ...
                        <div class="grid md:grid-cols-2 md:gap-6">
                            <div class="relative z-0 w-full mb-3 group">
                                ...
                                <select wire:model="studiekeuze_id" id="studiekeuzes"
                                    ...
                                    <option value="Selecteer een studiekeuze" selected disabled>Selecteer een
                                        studiekeuze.
                                    </option>
                            ...
                            <div class="relative z-0 w-full mb-3 group">
                                ...
                                <input wire:model="user_id"
                                       value="{{ $child->user->first_name ?? '' }} {{ $child->user->last_name ?? '' }}" disabled
                    ...
                    <button wire:click="removeUser({{ $child->id }})" class="text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-700" type="submit"
                    >Verwijderen
                    </button>
                </div>
